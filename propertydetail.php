            ...
            <div class="full-row">
                <div class="container">
                    <div class="row">
                        ...
                        <?php
                        $id = $_REQUEST['pid'];
                        $query = mysqli_query($con, "SELECT property.*, agent_requests.* FROM `property`,`agent_requests` WHERE property.uid=agent_requests.id and pid='$id'");
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                        if ($row['24'] == 'sold out') {
                                            echo '<div class="bg-danger d-table mt-3 px-3 py-2 rounded text-white text-capitalize">For ' . $row['24'] . '</div>';
                                        } else {
                                            echo '<div class="bg-info d-table mt-3 px-3 py-2 rounded text-white text-capitalize">For ' . $row['24'] . '</div>';
                                        }
                                        ?>
