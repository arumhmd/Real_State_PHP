...
<body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="pending-requests-datatable" class="table">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $getRequestsQuery = "SELECT * FROM agent_requests WHERE status = 'pending'";
                                        $result = mysqli_query($con, $getRequestsQuery);
    ...
    <script>
        // Initialize Datatables for Admin List
        $('#admin-datatable').DataTable();

        // Initialize Datatables for Pending Registration Requests
        $('#pending-requests-datatable').DataTable();
    </script>
