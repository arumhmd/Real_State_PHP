...
if(isset($_REQUEST['insert']))
{
	...
	if(!empty($name) && !empty($email) && !empty($pass)  && !empty($dob) && !empty($phone) && !empty($address))
	{
		$sql="insert into admin (auser,aemail,apass,adob,aphone,aaddress) values('$name','$email','$pass','$dob','$phone','$address')";
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<div class="social-login">
									...
									<a href="web.facebook.com" class="facebook"><i class="fa fa-facebook"></i></a>
									<a href="gmail.com" class="google"><i class="fa fa-google"></i></a>
