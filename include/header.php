                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+94 75 780 3773</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>arham@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								<?php } ?>
								| </li>
								<li><i class="fas fa-user-plus text-primary mr-1"></i><a href="register.php"> Register</li>
								</ul>
                            </div>
                        </div>
                    </div>
